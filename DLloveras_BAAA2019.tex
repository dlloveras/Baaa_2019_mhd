...
En el presente trabajo nos focalizaremos en el modelo MHD coronal y de viento solar  Alfvén Wave Solar atmosphere Model (AWSoM) que forma parte del space weather Modeling framework (SWMF) \citet{Toth_2012}. El modelo utiliza calentamiento por ondas de Alfvén para proveer un modelo físico descriptivo 3D auto consistente de calentamiento coronal y aceleración de viento solar citetsokolov2013  \citet{vander_2014}.
