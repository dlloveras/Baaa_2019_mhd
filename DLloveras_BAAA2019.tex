...
El modelo AWSOM utiliza magnetogramas synopticos de ADAPT-GONG \citep{arge_2010} como condiciones de contorno en la fotósfera y permite obtener una estructura 3D de parámetros físicos como ser densidad $N_e$ y temperatura electrónica $T_e$ entre otros parámetros físicos.
